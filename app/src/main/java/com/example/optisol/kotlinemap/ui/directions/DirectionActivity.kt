...
import com.example.optisol.kotlinemap.apiservices.DirectionService
import com.example.optisol.kotlinemap.model.Direction
import com.example.optisol.kotlinemap.model.Leg
...
import com.example.optisol.kotlinemap.model.Route
...
class DirectionActivity : BaseActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(map: GoogleMap?) {
        ...
        getDirection?.enqueue(object : Callback<Direction?> {
            override fun onResponse(call: Call<Direction?>?, response: Response<Direction?>) {
                response.body()?.let { getDirectionSuccess(it) }
            }
    ...
    private fun getDirectionSuccess(direction: Direction) {
