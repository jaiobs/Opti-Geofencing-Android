package com.example.orgware.kotlinemap.ui.tthree
...
class ThreeActivity : BaseActivity(), OnMapReadyCallback {
        ...
        when (requestCode) {
            REQUEST_LOCATION_CODE -> {
                if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this@ThreeActivity, "permission denied", Toast.LENGTH_LONG).show()
                }
                return
            }
        }
