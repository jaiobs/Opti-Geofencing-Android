...
class LocationManagerImpl :
    ...
    override fun getLastKnownPosition(
        activity: Activity,
        onLastLocationFound: ((Location) -> Unit)?,
        ...
        checkPermissionIsGranted(
            ...
            REQUEST_PERMISSION_FINE_LOCATION_FOR_LAST_POSITION
        )
    ...
    override fun startLocationTracker(
        activity: Activity,
        config: com.optisol.optigeofencingandroid.respones.locationmanager.LocationTrackerConfig,
        ...
        task.addOnSuccessListener { locationSettingsResponse ->
            ...
            checkPermissionIsGranted(
                ...
                REQUEST_PERMISSION_FINE_LOCATION_FOR_LOCATION_TRACKER
            )
        }
            ...
            if (exception is ResolvableApiException) {
                ...
                try {
                    ...
                    exception.startResolutionForResult(
                        activity,
                        REQUEST_CHECK_SETTINGS_FOR_LOCATION_TRACKKER
                    )
    ...
    private fun checkPermissionIsGranted(
        ...
        if (notGrantedPermissionList.isNotEmpty()) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(
                    activity,
                    notGrantedPermissionList.get(0)
                )
            ) {
